...
Version  : 0.12
Release  : 25
URL      : https://cpan.metacpan.org/authors/id/S/SM/SMUELLER/Text-FindIndent-0.12.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/S/SM/SMUELLER/Text-FindIndent-0.12.tar.gz
...
%prep
%setup -q -n Text-FindIndent-0.12
cd %{_builddir}
tar xf %{_sourcedir}/libtext-findindent-perl_0.11-1.debian.tar.xz
cd %{_builddir}/Text-FindIndent-0.12
mkdir -p deblicense/
cp -r %{_builddir}/debian/. %{_builddir}/Text-FindIndent-0.12/deblicense/
